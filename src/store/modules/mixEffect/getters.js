export default {
	...
	getLumaKeyEnabled: state => (name, slot, index) => state.elements[name].overlays[slot][index].linearKey.enabled,
	getLumaKeyInverted: state => (name, slot, index) => state.elements[name].overlays[slot][index].linearKey.inverted,
	getLumaKeyMinThreshold: state => (name, slot, index) => state.elements[name].overlays[slot][index].linearKey.min,
	getLumaKeyMaxThreshold: state => (name, slot, index) => state.elements[name].overlays[slot][index].linearKey.max,
